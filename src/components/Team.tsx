...
const Team = () => {
  ...
  return (
    <section id="team" className="py-24 bg-card relative overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom,hsl(45_85%_55%/0.03)_0%,transparent_50%)]" />
      ...
      <div className="container mx-auto px-6 relative">
        ...
        <AnimatedSection className="max-w-xl" direction="left" delay={0.2}>
          <div className="group relative rounded-2xl overflow-hidden bg-background border border-border hover:border-primary/30 transition-all duration-500">
            ...
            <div className="p-8 -mt-16 relative text-left">
              <div className="mb-6">
        ...
        <AnimatedSection className="mt-12" direction="left" delay={0.3}>
