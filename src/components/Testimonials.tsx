    ...
    <section className="py-24 bg-card">
      <div className="container mx-auto px-6">
        <AnimatedSection className="max-w-3xl mx-auto text-center mb-16" direction="left">
          ...
          <h2 className="font-display text-3xl md:text-4xl lg:text-5xl text-foreground mt-4 mb-6">What Our Clients Say</h2>
          <p className="font-sans text-muted-foreground text-lg leading-relaxed">Here's what our valued clients have to say about their experience working with us.</p>
        </AnimatedSection>

        <AnimatedSection direction="left" delay={0.2}>
          <div className="max-w-4xl mx-auto">
            <div className="relative bg-background border border-border p-10 md:p-14 rounded-2xl text-center">
              ...
              <div>
                ...
                <div className="flex flex-col items-center gap-4">
                  <div className="w-16 h-16 bg-gradient-primary flex items-center justify-center rounded-xl">
